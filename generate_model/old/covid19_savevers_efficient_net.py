...
from tensorflow.keras.applications import EfficientNetB0 # B0, cheapest
...
def create_sets(positive, negative):
  ...
  for filename in train_files:
    ...
    img = image.load_img(PATH+filename, target_size=(224, 224)) #efficientnet
...
model.save('/results/covid19_model_efficient_net')
